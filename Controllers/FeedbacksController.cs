...
namespace Fitness_Center_Management.Controllers
{
    public class FeedbacksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Feedbackid,Userid,Comments,Userregistrationdate,Isactive")] Feedback feedback)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Feedbackid,Userid,Comments,Userregistrationdate,Isactive")] Feedback feedback)
        {
