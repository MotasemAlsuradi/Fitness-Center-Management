...
namespace Fitness_Center_Management.Controllers
{
    public class ContactformsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Contactformid,Name,Email,Message")] Contactform contactform)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Contactformid,Name,Email,Message")] Contactform contactform)
        {
