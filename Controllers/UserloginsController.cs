...
namespace Fitness_Center_Management.Controllers
{
    public class UserloginsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Userloginid,Roleid,Username,Password")] Userlogin userlogin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Userloginid,Roleid,Username,Password")] Userlogin userlogin)
        {
